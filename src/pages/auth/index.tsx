    ...
    <div className='h-screen w-screen flex items-center justify-center'>
      ...
      <div className='bg-h-white flex flex-col-reverse lg:flex-row justify-between rounded-3xl shadow-lg max-w-[1438px] max-h-[954px] w-[90%] h-[80%]'>
        ...
        <div className='w-full h-[80%]  lg:w-[58%] lg:h-full p-[30px] lg:p-[80px] xl:px-[120px] flex flex-col items-center justify-between'>
          ...
          {/* form */}
          <div className='w-full h-auto flex flex-col justify-between items-center gap-5'>
            {/* inputs */}
            <form className='w-full h-auto flex flex-col justify-between gap-5'>

              {/* name */}
              <div className='flex flex-col gap-2'>
                <label htmlFor='name' className='text-h-primary hidden lg:block'>
                  First name
                </label>
                <input
                  type='text'
              ...
              <div className='flex flex-col items-start gap-2'>
                <label htmlFor='email' className='text-h-primary hidden lg:block'>
                  Email
                </label>
                <input
                  type='email'
              ...
              {/* password */}
              <div className='flex flex-col items-start gap-2'>
                <label htmlFor='password' className='text-h-primary hidden lg:block'>
                  Password
                </label>
  ...
  <div className='w-full h-[80%]  lg:w-[58%] lg:h-full p-[30px] lg:p-[80px] xl:px-[120px] flex flex-col items-center justify-between'>
    ...
    <div className='w-full h-auto flex flex-col items-center justify-between gap-4'>
      ...
      <div className='w-full h-auto flex flex-col items-center justify-between text-center'>
        ...
        <Text weight='regular' color='secondary' size='extraLarge' sx='mt-1'>
    ...
    <div className='w-full h-auto flex flex-col justify-between items-center gap-8 sm:gap-4'>
      ...
      <div className='w-full h-auto flex flex-col sm:flex-row justify-between items-center gap-2'>
        <label className='w-auto h-auto flex items-center text-h-secondary text-base'>
          <input type='checkbox' className='mr-2 checkbox-input' />
